...
<div
	class="group relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl border border-gray-200/50 dark:border-gray-700/50 hover:shadow-lg hover:shadow-gray-200/50 dark:hover:shadow-gray-900/50 transition-all duration-300 {
...
>
	...
	<div class="flex items-start justify-between mb-4">
		<div class="flex items-center space-x-3 flex-1">
			<!-- Indicador de color -->
			<div 
				class="w-4 h-4 rounded-full ring-2 ring-white dark:ring-gray-800 shadow-sm"
